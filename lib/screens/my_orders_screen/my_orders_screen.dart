...
import 'package:rebuyproject/controllers/my_orders_controller.dart';
...
class MyOrdersScreen extends StatelessWidget {
  ...
  Widget _buildOrderCard(Product product, MyOrdersController controller) {
    return Container(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    // Rating Button or Text
                    if (product.rating != null)
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [
                          Text(
                            'You rated ${product.rating!.toInt()}',
                            style: const TextStyle(
                              fontSize: 12,
                              color: Color(0xFF777777),
                            ),
                      ...
                      ElevatedButton(
                        onPressed: () => controller.rateProduct(product),
